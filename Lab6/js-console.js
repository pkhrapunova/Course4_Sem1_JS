...
function loadTask(num) {
    ...
    if (num === 1) {
        jsConsole.writeLine("Задание 1: Напишите функцию, которая заменяет пробелы в тексте на \"&amp;nbsp;\".");
        currentTask = task1;
    } else if (num === 2) {
        jsConsole.writeLine("Задание 2: Напишите функцию, которая возвращает индекс первого элемента в массиве, который больше его соседей, или -1, если нет такого элемента.");
        currentTask = task2;
    }
}