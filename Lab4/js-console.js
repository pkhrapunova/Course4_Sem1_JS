...
function loadTask(num) {
	...
	if (num === 1) {
		jsConsole.writeLine("Задание 1: Перевернуть строку.");
		currentTask = reverseString;
	} else if (num === 2) {
		jsConsole.writeLine("Задание 2: Проверка правильности скобок.");
		currentTask = processBrackets;
	}
}